...
# We can see that an input mask of 1 corresponds to an output mask of 15 a total of 14 times.
# This means that the sign of input & 1 is "too often" equal to the sign of output & 15.
# Or the first bit of the input is "too often" equal to the sum of the bits of the output.
